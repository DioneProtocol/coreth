...
func TestAP4BlockEncoding(t *testing.T) {
	blockEnc := common.FromHex("")
	var block Block
	if err := rlp.DecodeBytes(blockEnc, &block); err != nil {
		t.Fatal("decode error: ", err)
	}
	...
	check("Hash", block.Hash(), common.HexToHash("0x3157203e7908c53ae04bdd879319d78c22c58f4c7ae9b4102b136912cb31d5ef"))
	check("Nonce", block.Nonce(), uint64(0xa13a5a8c8f2bb1c4))
	check("Time", block.Time(), uint64(1426516743))
	check("Size", block.Size(), uint64(len(blockEnc)))
	check("BaseFee", block.BaseFee(), big.NewInt(1_000_000_000))
	check("UndistributedReward", block.UndistributedReward(), big.NewInt(12_000))
