...
func (h Header) MarshalJSON() ([]byte, error) {
	type Header struct {
		...
		UndistributedReward *hexutil.Big   `json:"undistributedReward" rlp:"optional"`
	...
	enc.UndistributedReward = (*hexutil.Big)(h.UndistributedReward)
...
func (h *Header) UnmarshalJSON(input []byte) error {
	...
	if dec.UndistributedReward != nil {
		h.UndistributedReward = (*big.Int)(dec.UndistributedReward)
	}
