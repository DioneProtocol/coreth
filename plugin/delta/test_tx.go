...
// DELTAStateTransfer implements the UnsignedAtomicTx interface
func (t *TestUnsignedTx) DELTAStateTransfer(ctx *snow.Context, state *state.StateDB) error {
	return t.DELTAStateTransferV
}
