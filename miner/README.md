...
In go-ethereum, the miner needs to perform PoW in order to try and produce the next block. Since Odyssey does not rely on PoW in any way, the miner within Coreth is only used to produce blocks on demand.
