...
# Set binary location
binary_path=${CORETH_BINARY_PATH:-"$GOPATH/src/github.com/dioneprotocol/dionego/build/plugins/evm"}

# Avalabs docker hub
dockerhub_repo="avaplatform/dionego"
...
build_image_id=${BUILD_IMAGE_ID:-"$dione_version-$coreth_commit_id"}
